...
class Snake:
    ...
    def __init__(self,block_size):
        ...
        self.image = pygame.image.load('D:\snake_AI-train\\snake.png')
...
class Berry:
    ...
    def __init__(self,block_size):
        self.block_size = block_size
        self.image = pygame.image.load('D:\snake_AI-train\\cherry.png')
...
class Wall:
    ...
    def __init__(self,block_size):
        self.block_size = block_size
        self.map = self.load_map('D:\snake_AI-train\\map.txt')
        self.image = pygame.image.load('D:\snake_AI-train\\tree.png')
...
class Game:
    ...
    def draw_data(self):
        ...
        text_img = self.font.render(text, 1, Game.BLACK)
